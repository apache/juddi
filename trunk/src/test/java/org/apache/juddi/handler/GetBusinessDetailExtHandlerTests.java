 ...
 */
public class  GetBusinessDetailExtHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.DeletePublisher.test";
	private  GetBusinessDetailExtHandler handler = null;

  public  GetBusinessDetailExtHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run( GetBusinessDetailExtHandlerTests.class);
  }
  ...
  public void setUp()
  {
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled  GetBusinessDetailExt ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled  GetBusinessDetailExt ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled  GetBusinessDetailExt ", unMarshalledString);
