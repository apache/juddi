 ...
 */
public class  FindQualifierHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.DeletePublisher.test";
	private  FindQualifierHandler handler = null;

  public  FindQualifierHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run( FindQualifierHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = ( FindQualifierHandler)maker.lookup( FindQualifierHandler.TAG_NAME);
  }

	private RegistryObject getRegistryObject()
	{
		FindQualifier object = new FindQualifier(FindQualifier.SORT_BY_NAME_ASC);
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled  FindQualifier ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled  FindQualifier ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled  FindQualifier ", unMarshalledString);
