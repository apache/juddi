 ...
 */
public class BusinessServiceHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.BusinessService.test";
	private BusinessServiceHandler handler = null;

  public BusinessServiceHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run(BusinessServiceHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = (BusinessServiceHandler)maker.lookup(BusinessServiceHandler.TAG_NAME);
  }
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled BusinessService ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled BusinessService ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled BusinessService ", unMarshalledString);
