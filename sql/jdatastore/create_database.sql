...
(
ENTITY_KEY VARCHAR(41) NOT NULL,
CREATED_DATE DATE NOT NULL,
CREATED_TIME TIME NOT NULL,
MODIFIED_DATE DATE NOT NULL,
MODIFIED_TIME DATE NOT NULL,
MODIFIED_INCLUDING_CHILDREN_DATE DATE NOT NULL,
MODIFIED_INCLUDING_CHILDREN_TIME TIME NOT NULL,
PRIMARY KEY (ENTITY_KEY)
);

CREATE TABLE OP_INFO_CHILD_TREE (
PARENT_ENTITY_KEY VARCHAR(41) NOT NULL,
CHILD_ENTITY_KEY VARCHAR(41) NOT NULL,
PRIMARY KEY (PARENT_ENTITY_KEY, CHILD_ENTITY_KEY),
FOREIGN KEY (PARENT_ENTITY_KEY) REFERENCES OPERATIONAL_INFO (ENTITY_KEY),
FOREIGN KEY (CHILD_ENTITY_KEY) REFERENCES OPERATIONAL_INFO (ENTITY_KEY)
);
