...
public class API_010_PublisherTest {
        ...
        public void getAllnodes() throws Exception {
                String rootPublisherStr = AppConfig.getConfiguration().getString(Property.JUDDI_ROOT_PUBLISHER);
                NodeList allNodes = publisher.getAllNodes(TckSecurity.getAuthToken(security, rootPublisherStr, ""));
        ...
        public void getAllclerks() throws Exception {
                String rootPublisherStr = AppConfig.getConfiguration().getString(Property.JUDDI_ROOT_PUBLISHER);
                ClerkList allNodes = publisher.getAllClerks(TckSecurity.getAuthToken(security, rootPublisherStr, ""));
                Assert.assertNotNull(allNodes);
