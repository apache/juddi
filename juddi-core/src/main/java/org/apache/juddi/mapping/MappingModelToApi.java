...
public class MappingModelToApi {
        ...
        public static void mapClientSubscriptionInfo(org.apache.juddi.model.ClientSubscriptionInfo modelClientSubscriptionInfo,
                ...
                try {
                        ...
                        gcal.setTime(modelClientSubscriptionInfo.getLastNotified());
                        apiClientSubscriptionInfo.setLastModified(df.newXMLGregorianCalendar(gcal));
                } catch (Exception ex) {
                        logger.fatal("Unable to convert date object to XMl Gregorian Calendar", ex);
                }
