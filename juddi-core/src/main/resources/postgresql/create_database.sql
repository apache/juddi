-- DROP TABLE ${prefix}UDDI_ENTITY CASCADE;
...
CREATE TABLE ${prefix}UDDI_ENTITY
(
        OBJECT_ID INT NOT NULL,
        OBJECT_KEY VARCHAR(41) NOT NULL,
        CONSTRAINT PK_UDDI_ENTITY PRIMARY KEY (OBJECT_KEY)
);
...
(
	...
	CONSTRAINT FK_BUSINESS_ENTITY_01 FOREIGN KEY (BUSINESS_KEY)
		REFERENCES ${prefix}UDDI_ENTITY (OBJECT_KEY)
		ON UPDATE CASCADE	
);
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY) 
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (5, 'uuid:4E49A8D6-D5A2-4FC2-93A0-0411D8D19E88');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (6, 'uuid:A035A07C-F362-44DD-8F95-E2B134BF43B4');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (7, 'uuid:4064C064-6D14-4F35-8953-9652106476A9');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (8, 'uuid:807A2C6A-EE22-470D-ADC7-E0424A337C03');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (9, 'uuid:327A56F0-3299-4461-BC23-5CD513E95C55');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (10, 'uuid:E59AE320-77A5-11D5-B898-0004AC49CC1E'); 
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (11, 'uuid:8609C81E-EE1F-4D5A-B202-3EB13AD01823');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (12, 'uuid:B1B1BAF5-2329-43E6-AE13-BA8E97195039');
...
----- WSDL Address Model
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (13, 'uuid:AD61DE98-4DB8-31B2-A299-A2373DC97212');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (14, 'uuid:E5C43936-86E4-37BF-8196-1D04B35C0099');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (15, 'uuid:4DC74177-7806-34D9-AECD-33C57DC3A865');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (16, 'uuid:6E10B91B-BABC-3442-B8FC-5A3C8FDE0794');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (17, 'uuid:AA254698-93DE-3870-8DF3-A5C075D64A0E');
...
----- portType reference
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (18, 'uuid:082B0851-25D8-303C-B332-F24A6D53E38E');
...
----- local name tmodel
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (19, 'uuid:2EC65201-9109-3919-9BEC-C9DBEFCACCF6');
...
----- namespace tmodel
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (20, 'uuid:D01987D1-AB2E-3013-9BE2-2A66EB99D824');
...
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (21, 'uuid:6E090AFA-33E5-36EB-81B7-1CA18373F457');
...
----- ** http transport **
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (22, 'uuid:68DE9E80-AD09-469D-8A37-088422BFBC36');
...
----- ** uddi inquiry **
INSERT INTO ${prefix}UDDI_ENTITY (OBJECT_ID, OBJECT_KEY)VALUES (23, 'uuid:AC104DCC-D623-452F-88A7-F8ACD94D9B2B');
