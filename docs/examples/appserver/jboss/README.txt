To deploy the juddiv3.war to JBoss.

0. Create a new directory server/default/deploy/juddiv3.war and extract the juddiv3.war files in this directory.
...
4. Add the mysql driver to server/default/lib
