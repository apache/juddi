...
<h3><%= requestName%></h3>
<div class="link">
The find_business API call returns a businessList message that matches the conditions 
specified in the arguments.
If any error occurs in processing this API call, a dispositionReport element will 
be returned to the caller within a SOAP Fault containing an error number indicating 
<a href="/uddi_errors#E_invalidKeyPassed">E_invalidKeyPassed</a>,
<a href="/uddi_errors#E_unsupported">E_unsupported</a> or 
<a href="/uddi_errors#E_tooManyOptions">E_tooManyOptions</a> error was encountered.
</div>
