 ...
 *
 * The config loads from META-INF and uses INVM transport, meaning that you
 * don't need a functioning UDDI server to use this. The jUDDI services in this
 * case fire up in without any J2EE container. A database is still required,
 * however by default it uses Derby, but any JPA database can be used
 *
 */
