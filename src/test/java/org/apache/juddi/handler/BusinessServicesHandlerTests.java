 ...
 */
public class BusinessServicesHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.BusinessServices.test";
	private BusinessServicesHandler handler = null;

  public BusinessServicesHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run(BusinessServicesHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = (BusinessServicesHandler)maker.lookup(BusinessServicesHandler.TAG_NAME);
  }
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled BusinessServices ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled BusinessServices ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled BusinessServices ", unMarshalledString);
