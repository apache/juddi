 ...
 */
public class BusinessDetailHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.BusinessDetail.test";
	private BusinessDetailHandler handler = null;

  public BusinessDetailHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run(BusinessDetailHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = (BusinessDetailHandler)maker.lookup(BusinessDetailHandler.TAG_NAME);
  }
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled BusinessDetail ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled BusinessDetail ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled BusinessDetail ", unMarshalledString);
