 ...
 */
public class  InstanceParmsHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.DeletePublisher.test";
	private  InstanceParmsHandler handler = null;

  public  InstanceParmsHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run( InstanceParmsHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = ( InstanceParmsHandler)maker.lookup( InstanceParmsHandler.TAG_NAME);
  }

	private RegistryObject getRegistryObject()
	{
		InstanceParms object = new InstanceParms();
		object.setText("iParms-whatever");
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled  InstanceParms ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled  InstanceParms ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled  InstanceParms ", unMarshalledString);
