 ...
 */
public class  RelatedBusinessInfosHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.DeleteRelatedBusinessInfos.test";
	private  RelatedBusinessInfosHandler handler = null;

  public  RelatedBusinessInfosHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run( RelatedBusinessInfosHandlerTests.class);
  }
  ...
  public void setUp()
  {
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled  RelatedBusinessInfos ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled  RelatedBusinessInfos ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled  RelatedBusinessInfos ", unMarshalledString);
