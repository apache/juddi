 ...
 */
public class  ServiceDetailHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.DeleteServiceDetail.test";
	private  ServiceDetailHandler handler = null;

  public  ServiceDetailHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run( ServiceDetailHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = ( ServiceDetailHandler)maker.lookup( ServiceDetailHandler.TAG_NAME);
  }
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled  ServiceDetail ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled  ServiceDetail ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled  ServiceDetail ", unMarshalledString);

		boolean equals = marshalledString.equals(unMarshalledString);

		assertEquals("Expected ServiceDetail: ", marshalledString, unMarshalledString );
  }
