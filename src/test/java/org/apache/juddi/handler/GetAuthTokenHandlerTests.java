 ...
 */
public class  GetAuthTokenHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.DeletePublisher.test";
	private  GetAuthTokenHandler handler = null;

  public  GetAuthTokenHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run( GetAuthTokenHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = ( GetAuthTokenHandler)maker.lookup( GetAuthTokenHandler.TAG_NAME);
  }

	private RegistryObject getRegistryObject()
	{
		GetAuthToken object = new GetAuthToken();

		object.setUserID("juddi");
		object.setCredential("password");
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled  GetAuthToken ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled  GetAuthToken ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled  GetAuthToken ", unMarshalledString);
