 ...
 */
public class BindingTemplatesHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.BindingTemplates.test";
	private BindingTemplatesHandler handler = null;

  public BindingTemplatesHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run(BindingTemplatesHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = (BindingTemplatesHandler)maker.lookup(BindingTemplatesHandler.TAG_NAME);
  }
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled BindingTemplates ", unMarshalledString);
