 ...
 */
public class DeleteServiceHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.DeletePublisher.test";
	private DeleteServiceHandler handler = null;

  public DeleteServiceHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run(DeleteServiceHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = (DeleteServiceHandler)maker.lookup(DeleteServiceHandler.TAG_NAME);
  }
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled DeleteService ", unMarshalledString);
