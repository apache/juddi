 ...
 */
public class AddressHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.address.test";
	private AddressHandler handler = null;

  public AddressHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run(AddressHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = (AddressHandler)maker.lookup(AddressHandler.TAG_NAME);
  }
