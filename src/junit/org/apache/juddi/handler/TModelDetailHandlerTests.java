 ...
 */
public class  TModelDetailHandlerTests extends HandlerTestCase
{
	private static final String TEST_ID = "juddi.handler.DeleteTModelDetail.test";
	private  TModelDetailHandler handler = null;

  public  TModelDetailHandlerTests(String arg0)
  {
    super(arg0);
  }
  ...
  {
    junit.textui.TestRunner.run( TModelDetailHandlerTests.class);
  }

  public void setUp()
  {
		HandlerMaker maker = HandlerMaker.getInstance();
		handler = ( TModelDetailHandler)maker.lookup( TModelDetailHandler.TAG_NAME);
  }
	...
	public void testMarshal()
	{
		...
		assertNotNull("Marshalled  TModelDetail ", marshalledString);
	...
	public void testUnMarshal()
	{
		...
		assertNotNull("UnMarshalled  TModelDetail ", regObject);
  ...
  public void testMarshUnMarshal()
  {
		...
		assertNotNull("Unmarshalled  TModelDetail ", unMarshalledString);

		boolean equals = marshalledString.equals(unMarshalledString);

		assertEquals("Expected TModelDetail: ", marshalledString, unMarshalledString );
  }
