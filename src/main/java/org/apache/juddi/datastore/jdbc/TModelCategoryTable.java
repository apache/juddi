...
class TModelCategoryTable
{
  ...
  static
  {
   tablePrefix = Config.getStringProperty(
    ...
    sql.append("INSERT INTO ").append(tablePrefix).append("TMODEL_CATEGORY (");
    ...
    sql.append("KEY_VALUE, ");
    sql.append("CATEGORY_ID ");
    sql.append("FROM ").append(tablePrefix).append("TMODEL_CATEGORY ");
    ...
    sql.append("DELETE FROM ").append(tablePrefix).append("TMODEL_CATEGORY ");
    sql.append("WHERE TMODEL_KEY=?");
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      if (log.isDebugEnabled()) {
          log.debug(
            "select from " + tablePrefix + "TMODEL_CATEGORY table:\n\n\t"
              + selectSQL
              + "\n\t TMODEL_KEY="
              + tModelKey.toString()
              + "\n");
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
      ...
      if (log.isDebugEnabled()) {
          log.debug(
            "delete from " + tablePrefix + "TMODEL_CATEGORY table:\n\n\t"
              + deleteSQL
              + "\n\t TMODEL_KEY="
              + tModelKey.toString()
              + "\n");
