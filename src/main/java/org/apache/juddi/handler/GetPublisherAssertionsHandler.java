 ...
 */
public class GetPublisherAssertionsHandler extends AbstractHandler
{
  public static final String TAG_NAME = "get_publisherAssertions";

  private HandlerMaker maker = null;

  protected GetPublisherAssertionsHandler(HandlerMaker maker)
  {
    this.maker = maker;
  }
