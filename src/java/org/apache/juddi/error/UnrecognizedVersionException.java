 ...
 */
public class UnrecognizedVersionException extends RegistryException
{
  public UnrecognizedVersionException(String msg)
  {
    ...
    String errMsg = Result.E_UNRECOGNIZED_VERSION_MSG;

    Result result = new Result(
      Result.E_UNRECOGNIZED_VERSION,
      Result.E_UNRECOGNIZED_VERSION_CODE,
      errMsg);
