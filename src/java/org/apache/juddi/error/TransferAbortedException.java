 ...
 */
public class TransferAbortedException extends RegistryException
{
  public TransferAbortedException(String msg)
  {
    ...
    String errMsg = Result.E_TRANSFER_ABORTED_MSG;

    Result result = new Result(
      Result.E_TRANSFER_ABORTED,
      Result.E_TRANSFER_ABORTED_CODE,
      errMsg);
