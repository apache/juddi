 ...
 */
public class BusinessEntityExtHandler extends AbstractHandler
{
  public static final String TAG_NAME = "businessEntityExt";

  private HandlerMaker maker = null;

  protected BusinessEntityExtHandler(HandlerMaker maker)
  {
    this.maker = maker;
  }
    ...
    throws Exception
  {
    ...
    AbstractHandler handler = maker.lookup(BusinessEntityExtHandler.TAG_NAME);
