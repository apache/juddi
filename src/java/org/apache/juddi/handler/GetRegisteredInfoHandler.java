...
public class GetRegisteredInfoHandler extends AbstractHandler
{
  ...
  protected GetRegisteredInfoHandler(HandlerMaker maker)
  {
    this.maker = maker;
  }
  ...
  {
    GetRegisteredInfo obj = new GetRegisteredInfo();
  ...
  AbstractHandler handler = maker.lookup(GetRegisteredInfoHandler.TAG_NAME);
    ...
    GetRegisteredInfo service = new GetRegisteredInfo();
