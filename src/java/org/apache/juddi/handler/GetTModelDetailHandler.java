 ...
 * Returns GetTModelDetail."
 *
 * @author Steve Viens (sviens@apache.org)
 */
public class GetTModelDetailHandler extends AbstractHandler
{
  public static final String TAG_NAME = "get_tModelDetail";

  private HandlerMaker maker = null;

  protected GetTModelDetailHandler(HandlerMaker maker)
  {
    this.maker = maker;
  }
  ...
  {
    GetTModelDetail obj = new GetTModelDetail();
  ...
  AbstractHandler handler = maker.lookup(GetTModelDetailHandler.TAG_NAME);

    Element parent = XMLUtils.newRootElement();
    Element child = null;

    GetTModelDetail service = new GetTModelDetail();
