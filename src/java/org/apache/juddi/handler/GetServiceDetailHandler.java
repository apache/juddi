...
public class GetServiceDetailHandler extends AbstractHandler
{
  ...
  protected GetServiceDetailHandler(HandlerMaker maker)
  {
    this.maker = maker;
  }
  ...
  {
    GetServiceDetail obj = new GetServiceDetail();
  ...
  AbstractHandler handler = maker.lookup(GetServiceDetailHandler.TAG_NAME);
