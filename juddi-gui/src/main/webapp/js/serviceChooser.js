...
function RenderServiceListBySearchModal(keyword1, offset1, maxrecords1, isForChooser)
{
   ...
   var keyword = $("#name_Service").val();
   var lang = $("#lang_Service").val();
   if (lang == undefined)
      lang = "";
   ...
   var request = $.ajax({
      url: 'ajax/servicesearch.jsp?keyword=' + keyword + "&offset=" + offset1 + "&maxrecords=" + maxrecords1 + "&lang=" + lang + "&chooser=" + isForChooser + "&findqualifier=" + fq,
      type: "GET",
      cache: false
   });
